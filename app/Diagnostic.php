...
class Diagnostic extends Model
{
    ...
    public static function activeDiagnostics()
    {
        ...
        ->select("diagnostic_clients.id", "diagnostic_clients.diagnostic_id", "diagnostics.name", "diagnostic_clients.client_id", "diagnostics.rank", "diagnostic_clients.date", "diagnostic_clients.comments")
